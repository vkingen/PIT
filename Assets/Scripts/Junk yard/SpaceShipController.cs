...
public class SpaceShipController : MonoBehaviour
{
    ...
    private void HandleInput()
    {
        ...
        else
        {
            ...
            rollValue = -joint.connectedBody.transform.rotation.z;
            pitchValue = joint.connectedBody.transform.rotation.x;
        }
    ...
    private void FixedUpdate()
    {
        ...
        //rigidbody.AddForce(Vector3.up * rigidbody.velocity.magnitude * liftValue);
    }
